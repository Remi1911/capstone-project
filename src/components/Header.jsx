      ...
      >
        ...
        <nav className="mt-6">
          <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
            ...
            <MobileNavItem href="/hobbies">Hobbies</MobileNavItem>
  ...
  return (
    ...
    >
      <Image
        ...
        className={clsx(
          'rounded-full bg-zinc-100 object-cover dark:bg-zinc-800 border-4 border-blue-400',
...
export function Header() {
  ...
  return (
    <>
      <header
        className="pointer-events-none relative z-50 flex flex-none flex-col bg-pattern h-24"
        style={{
